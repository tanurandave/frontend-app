...
import { Search, Plus, User, BookOpen, Calendar, CheckCircle, XCircle, Users, Check, Trash2, Eye, Clock, ChevronLeft, ChevronRight, X } from 'lucide-react'
              ...
              <div className="lg:col-span-7 flex flex-col h-[500px]">
                ...
                <div className="relative mb-3">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-9 py-2 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                  />
                  {studentSearchTerm && (
                    <button
